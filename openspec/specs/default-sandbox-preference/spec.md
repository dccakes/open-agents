# default-sandbox-preference Specification

## Purpose

Let a user pick a default sandbox provider and keep that choice honest as providers are enabled, configured, or disabled.
