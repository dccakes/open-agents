# sandbox-env-injection Specification

## Purpose

Resolve a session's environment variables from a configurable backend and inject them into the sandbox without persisting or logging secrets.
