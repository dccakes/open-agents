# sandbox-provider-daytona-stub Specification

## Purpose

Register Daytona as a beta sandbox provider, mapping the sandbox contract onto Daytona workspace primitives including pause/resume.
