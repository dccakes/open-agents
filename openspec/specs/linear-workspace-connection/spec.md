# linear-workspace-connection Specification

## Purpose

Connect a Linear workspace over OAuth, register its webhook automatically, and expose the connection state in settings.
