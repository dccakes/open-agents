# tool-call-enforcement Specification

## Purpose

Enforce policy inside the shared tool factories, where execute is the authoritative gate and a refusal is a structured tool result.
