# org-roles-and-permissions Specification

## Purpose

Define platform roles and organization roles once, in a shared access-control statement set, and keep them distinct.
