...
Keep every environment variable behind a typed, validated config module, so a missing or malformed variable fails at build time rather than at request time.
