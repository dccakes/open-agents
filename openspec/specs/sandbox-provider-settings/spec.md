# sandbox-provider-settings Specification

## Purpose

Give each sandbox provider a settings card that reflects its structural availability and lets a user enable and configure it.
